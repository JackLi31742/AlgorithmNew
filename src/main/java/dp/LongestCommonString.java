...
public class LongestCommonString {
	...
	public static void getEnd(int i,int j,int iStart,int iEnd,int jStart, int jEnd
			,int temp,int max,int end,String A,String B) {
		while(i>=iStart&&i<=iEnd&&j>=jStart&&j<jEnd) {
